...
function Testimonials() {
  const reviews = [
    { name: 'Hamza', city: 'Faisalabad', quote: "Best Rs. 1,499 I've ever spent. The client outreach scripts alone got me a $150 client on WhatsApp in 3 days!", badge: '✓ Earning Verified' },
